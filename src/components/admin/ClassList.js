...
const ClassList = ({
    ...
    const handleUpdate = () => {
        if (editingClass) {
            const selectedTeacher = teachers.find((t) => t.username === editTeacher);

            onEditClass(editingClass.id, {
                name: editName !== editingClass.name ? editName : undefined,
                homeroomTeacher:
                    selectedTeacher && selectedTeacher.username !== editingClass.teacher?.username
                        ? selectedTeacher
                        : undefined,
            });
                        ...
                        <tr key={cls.id}>
                            ...
                            <td>
                                {editingClass?.id === cls.id ? (
                                    ...
                                    <>
                                        <button className={styles.editBtn} onClick={() => handleEdit(cls)}>
                                            <svg
                                                width="16"
                                                height="16"
                                                viewBox="0 0 24 24"
                                        ...
                                        <button className={styles.deleteBtn} onClick={() => onDeleteClass(cls.id)}>
                                            <svg
                                                width="16"
                                                height="16"
                                                viewBox="0 0 24 24"
